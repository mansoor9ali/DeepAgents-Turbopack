...
This module provides tools for accessing
...
@tool(
    name_or_callable="get_historical_stock_prices",
...
@tool(
    name_or_callable="get_stock_info",
...
@tool(
    name_or_callable="get_yahoo_finance_news",
...
@tool(
    name_or_callable="get_stock_actions",
...
@tool(
    name_or_callable="get_financial_statement",
...
@tool(
    name_or_callable="get_holder_info",
...
@tool(
    name_or_callable="get_option_expiration_dates",
...
@tool(
    name_or_callable="get_option_chain",
...
@tool(
    name_or_callable="get_recommendations",
